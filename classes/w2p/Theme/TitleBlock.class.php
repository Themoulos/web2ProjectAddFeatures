...
class w2p_Theme_TitleBlock {
    ...
    /**
     * Creates a standarised, right-aligned Delete All Recuring Tasks bread-crumb and icon.
     */
    public function addCrumbDeleteAllTasks($title, $canDelete = '', $msg = '') {
        $this->addCrumbRight('<a class="delete" href="javascript:delAllTasks()" title="' . ($canDelete ? '' : $msg) . '"><div>' . $this->_AppUI->_($title) . '</div></a>');
    }
