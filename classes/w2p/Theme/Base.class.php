...
abstract class w2p_Theme_Base
{
    ...
    public function styleRenderBoxTop() {
        ...
        $ret = '';
        $ret .= '<table border-radius= "0px" width="100%" cellspacing="0" cellpadding="0" class="man_clear" >';
        $ret .= '<tbody>';
        $ret .= '<tr>';
    ...
    public function styleRenderBoxBottom($tab = 0) {
        ...
        $ret = '';
        $ret .= '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="man_clear" >';
        $ret .= '<tbody>';
        $ret .= '<tr>';
