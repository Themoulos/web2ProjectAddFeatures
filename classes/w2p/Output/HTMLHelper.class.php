...
*/
            case '_name':
                ...
                $link   = ($prefix == 'message') ? '?m=forums&a='.$page . '&forum_id='.$this->tableRowData['forum_id'].'&' : $link;
...
//TODO: task_logs are another oddball..
            ...
            case '_problem':
                ...
                break;
            case '_topics':
                $topic_id = $this->tableRowData['message_id'];
                $forum_id = $this->tableRowData['forum_id'];
                $cell ='<a href="?m=forums&a=viewer&forum_id='.$forum_id.'&message_id='.$topic_id;
                break;
            default:
